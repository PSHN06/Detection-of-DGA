...
def main():
    ...
    print("Fitting baseline XGBoost model on the training set...")
    ...
    # Print metrics
    print("\n" + "="*50)
    print("           ADVANCED XGBOOST MODEL EVALUATION REPORT           ")
    print("="*50)
    print(f"Training Time:      {train_time:.4f} seconds")
    ...
    model_file = "advanced_xgb_model.json"
    print(f"Saving trained model checkpoint to {model_file}...")
